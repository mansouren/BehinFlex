    ...
    (function () {
        !function (e, t) {
            kendo.ui.FlatColorPicker && (kendo.ui.FlatColorPicker.prototype.options.messages = e.extend(!0, kendo.ui.FlatColorPicker.prototype.options.messages, {
                ...
                string: {
                    eq: "برابر باشد با", neq: "برابر نباشد با", startswith: "شروع شود با", contains: "شامل باشد", doesnotcontain: "شامل نباشد", endswith: "پایان یابد با"
                }
                , number: {
                    eq: "برابر باشد با", neq: "برابر نباشد با", gte: "برابر یا بزرگتر باشد از", gt: "بزرگتر باشد از", lte: "کمتر و یا برابر باشد با", lt: "کمتر باشد از"
                }
                , date: {
                    eq: "برابر باشد با", neq: "برابر نباشد با", gte: "بعد از یا هم زمان باشد با", gt: "بعد از", lte: "قبل از یا هم زمان باشد با", lt: "قبل از"
                }
                , enums: {
                    eq: "برابر باشد با", neq: "برابر نباشد با"
                }
            }
                ...
                info: "ردیف های را نشان بده که:", title: "ردیف های را نشان بده که:", isTrue: "درست باشد", isFalse: "درست نباشد", filter: "فیلتر", clear: "پاک کردن", and: "و", or: "یا", selectValue: "-انتخاب مقدار-", operator: "عملگر", value: "مقدار", cancel: "انصراف"
            }
